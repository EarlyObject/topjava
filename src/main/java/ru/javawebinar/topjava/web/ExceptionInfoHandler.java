...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        return logAndGetErrorInfo(req, e, true, DATA_ERROR, Collections.singletonList("User with this email already exists"));
    }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException,
                                                ErrorType errorType, List<String> errorDetails) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, isEmpty(errorDetails) ?
                Collections.singletonList(rootCause.toString()) : Collections.singletonList(errorDetails.toString()));
    }
}