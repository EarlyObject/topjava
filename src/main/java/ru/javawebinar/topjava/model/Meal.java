...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull
    private @Range(min = 10, max = 5000) Integer calories;
...
//    @NotNull
    ...
    public @Range(min = 10, max = 5000) Integer getCalories() {
        return calories;
    }
    ...
    public void setCalories(@Range(min = 10, max = 5000) Integer calories) {
        this.calories = calories;
    }
